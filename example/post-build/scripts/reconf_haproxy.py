...
''' 
python /opt/marathon-lb/marathon_lb.py --marathon http://mesos-master2.smdonkey.com:8080 --group rest --group rest --group auth --group process --group web --ssl-certs /etc/haproxy/cert1.pem
'''
